...
(function (pxsim) {
    ...
    var DalBoard = /** @class */ (function (_super) {
        ...
        function DalBoard() {
            ...
            _this.builtinParts["led"] = _this.ledState = new pxsim.LedState(pxsim.runtime);
            return _this;
...
(function (pxsim) {
    var braingamer;
    (function (braingamer) {
        function __setVibrate(on) {
        }
        braingamer.__setVibrate = __setVibrate;
    })(braingamer = pxsim.braingamer || (pxsim.braingamer = {}));
})(pxsim || (pxsim = {}));
var pxsim;
(function (pxsim) {
    var game;
...
(function (pxsim) {
    var LedState = /** @class */ (function () {
        function LedState(runtime) {
            this.animationQ = new pxsim.AnimationQueue(runtime);
        }
        LedState.prototype.setState = function (on) {
            this.on = on;
        };
    ...
    (function (visuals) {
        ...
        var BrainPadBoardSvg = /** @class */ (function () {
            ...
            BrainPadBoardSvg.prototype.updateLed = function () {
                ...
                if (!state)
                    return;
                var on = state.ledState.getState();
                if (this.led) {
                    if (on) {
